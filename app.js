...
const sources = {
  ...
  reutersIndiaImportsPlan: {
    en: "Reuters, July 1, 2026: at least 60,000 tons of gasoline were dispatched from India, while Russia plans up to 400,000 tons of monthly imports from several countries.",
    ru: "Reuters, 1 июля 2026: из Индии отправлено не менее 60 000 тонн бензина, а Россия планирует до 400 000 тонн импорта в месяц из нескольких стран.",
  },
  ...
  reutersMoscowRefineryLongStop: {
    en: "Reuters via RFE/RL, June 24, 2026: Moscow refinery is unlikely to resume operations before the end of 2026 after two drone strikes.",
    ru: "Reuters через Радио Свобода, 24 июня 2026: Московский НПЗ вряд ли возобновит работу до конца 2026 года после двух ударов дронов.",
  },
  kremlinFuel: {
  ...
  rosstatPrices: {
    en: "Rosstat, June 23-29, 2026: gasoline rose 1.61% in a week, diesel rose 2.23%, average gasoline reached 72.38 RUB/L and diesel 84.84 RUB/L.",
    ru: "Росстат, 23-29 июня 2026: бензин вырос на 1,61% за неделю, дизель на 2,23%, средний бензин достиг 72,38 руб/л, дизель 84,84 руб/л.",
  },
  governmentJetFuelBan: {
    en: "Russian government, June 1, 2026: aviation kerosene exports are banned until November 30 to stabilize the domestic fuel market.",
    ru: "Правительство РФ, 1 июня 2026: экспорт авиакеросина запрещен до 30 ноября для стабилизации внутреннего топливного рынка.",
  },
  centralBankInflation: {
    en: "Bank of Russia, July 1, 2026: the fuel-market situation may have a longer inflation impact than previous episodes.",
    ru: "Банк России, 1 июля 2026: ситуация на топливном рынке может дольше влиять на инфляцию, чем прошлые эпизоды.",
  },
  seed: {
...
const seedEvents = [
  ...
  {
    id: "russia-july2-import-plan-coverage",
    type: "region",
    title: T("Russia: import plan covers only part of gasoline gap", "Россия: импортный план закрывает только часть бензинового разрыва"),
    region: T("Russia fuel import logistics", "Импортная топливная логистика РФ"),
    place: T("National import plan, rounded", "Общероссийский импортный контур, округлено"),
    lat: 46.9,
    lng: 39.6,
    severity: "serious",
    status: T("Reuters reported at least 60,000 tons dispatched from India and a plan for up to 400,000 tons per month from several countries, while the research model estimates a roughly 30,000 t/day gasoline output gap", "Reuters сообщил о не менее 60 000 тонн из Индии и плане до 400 000 тонн в месяц из нескольких стран, тогда как модель ресерча оценивает разрыв выпуска бензина примерно в 30 000 т/сутки"),
    fuel: T("Gasoline import plan / shortage mitigation", "Импорт бензина / смягчение дефицита"),
    lossWeight: 6,
    impactMode: "support",
    impactMetric: "400,000 t/mo",
    impactMetricLabel: T("target monthly imports", "целевой импорт в месяц"),
    impactScope: T("National import buffer, not a local availability signal", "Общероссийский импортный буфер, не локальный сигнал доступности"),
    impactCaveat: T("Offsets part of the supply gap but does not remove refinery or transport bottlenecks", "Компенсирует часть разрыва, но не снимает узкие места НПЗ и транспорта"),
    confidence: T("High for Reuters import report, medium for coverage ratio because it depends on model assumptions", "Высокая по отчету Reuters об импорте, средняя по доле покрытия из-за модельных допущений"),
    source: "reutersIndiaImportsPlan",
    sourceUrl: "https://gcaptain.com/russia-buys-gasoline-from-india-to-tackle-shortages-sources-say/",
  ...
  {
    id: "russia-rosstat-week-23-29-june-price-shock",
    type: "region",
    title: T("Russia: Rosstat weekly fuel price shock", "Россия: недельный ценовой шок Росстата по топливу"),
    region: T("Russia nationwide", "Россия, общероссийский уровень"),
    place: T("Nationwide price index, rounded", "Общероссийский индекс цен, округлено"),
    lat: 58.5,
    lng: 76.0,
    severity: "serious",
    status: T("Rosstat reported gasoline up 1.61% and diesel up 2.23% in the June 23-29 week, with average gasoline at 72.38 RUB/L and diesel at 84.84 RUB/L", "Росстат сообщил рост бензина на 1,61% и дизеля на 2,23% за неделю 23-29 июня, средний бензин 72,38 руб/л, дизель 84,84 руб/л"),
    fuel: T("Gasoline / diesel retail prices", "Розничные цены бензина / дизеля"),
    lossWeight: 6,
    impactMode: "stress",
    impactMetric: "72.38 RUB/L",
    impactMetricLabel: T("avg gasoline", "средний бензин"),
    impactScope: T("National average hides larger regional spikes, including Sevastopol plus 30% for the week", "Средняя по РФ скрывает более резкие региональные скачки, включая Севастополь плюс 30% за неделю"),
    confidence: T("High: Rosstat figures reported by Interfax and other outlets", "Высокая: данные Росстата переданы Интерфаксом и другими изданиями"),
    source: "rosstatPrices",
    sourceUrl: "https://www.interfax.ru/business/1099565",
    observedAt: "2026-07-01",
    issueType: "price_spike",
  },
  {
  ...
  {
    id: "moscow-refinery-unlikely-restart-2026",
    type: "infrastructure",
    title: T("Moscow refinery: unlikely to restart in 2026", "Московский НПЗ: вероятный простой до конца 2026 года"),
    region: T("Moscow / Moscow Oblast", "Москва / Московская область"),
    place: T("Moscow refinery supply zone, rounded", "Зона снабжения Московского НПЗ, округлено"),
    lat: 55.63,
    lng: 37.79,
    severity: "critical",
    status: T("Reuters sources said the Moscow refinery is unlikely to resume operations before year-end after June strikes, a long outage that structurally worsens the capital-region supply balance", "Источники Reuters сообщили, что Московский НПЗ вряд ли возобновит работу до конца года после июньских ударов, что структурно ухудшает баланс снабжения столичного региона"),
    fuel: T("Refinery outage / gasoline and diesel supply", "Простой НПЗ / снабжение бензином и дизелем"),
    lossWeight: 10,
    impactMode: "stress",
    impactMetric: "2026",
    impactMetricLabel: T("restart unlikely before", "перезапуск маловероятен до"),
    impactScope: T("Capital-region refining and distribution system", "Столичный контур переработки и распределения"),
    impactCaveat: T("Long-duration refinery outage, not a single gas-station queue", "Долгий простой НПЗ, а не одиночная очередь на АЗС"),
    confidence: T("High for Reuters sourced reporting", "Высокая по сообщению Reuters"),
    source: "reutersMoscowRefineryLongStop",
    sourceUrl: "https://www.svoboda.org/a/reuters-moskovskiy-npz-ne-smozhet-rabotatj-do-kontsa-goda/33787874.html",
    observedAt: "2026-07-02",
  ...
  {
    id: "russia-july2-systemic-fuel-chain-stress",
    type: "region",
    title: T("Russia: July 2 systemic fuel-chain stress", "Россия: системный стресс топливной цепочки на 2 июля"),
    region: T("Russia nationwide", "Россия, общероссийский уровень"),
    place: T("Refinery to oil depot to transport to retail chain, rounded", "Цепочка НПЗ - нефтебаза - транспорт - розница, округлено"),
    lat: 59.1,
    lng: 73.0,
    severity: "critical",
    status: T("Research update: gasoline stocks fell from 1.7036 Mt on June 20 to 1.6334 Mt on June 29, about 7.8 kt/day drawdown, while late-June gasoline output was roughly 90 kt/day and about 25% below June 2025", "Ресерч-апдейт: остатки бензина снизились с 1,7036 млн т 20 июня до 1,6334 млн т 29 июня, около 7,8 тыс т/сутки вымывания, при выпуске бензина в конце июня около 90 тыс т/сутки и минус 25% к июню 2025"),
    fuel: T("Gasoline balance / systemic supply chain", "Баланс бензина / системная цепочка снабжения"),
    lossWeight: 9,
    impactMode: "stress",
    impactMetric: "7.8 kt/day",
    impactMetricLabel: T("stock drawdown", "вымывание запасов"),
    impactScope: T("National balance, regional access remains uneven", "Федеральный баланс, региональная доступность остается неравномерной"),
    impactCaveat: T("Analytical composite from official stock data and Reuters output reporting", "Аналитический композит из официальных данных по остаткам и сообщений Reuters о выпуске"),
    confidence: T("High for stock data, medium for modelled output-gap interpretation", "Высокая по остаткам, средняя по модельной интерпретации разрыва выпуска"),
    source: "minenergoBalance",
    sourceUrl: "https://minenergo.gov.ru/press-center/news-and-events?news-item=itogi-ocherednogo-shtaba-po-monitoringu-proizvodstva-i-potrebleniya-nefteproduktov-v-rossii-22",
    observedAt: "2026-07-02",
    issueType: "regional_rationing",
  ...
  {
    id: "russia-export-controls-jetfuel-diesel-july2",
    type: "region",
    title: T("Russia: export controls move deeper into fuels", "Россия: экспортные ограничения расширяются по топливам"),
    region: T("Russia nationwide", "Россия, общероссийский уровень"),
    place: T("Federal export-control layer, rounded", "Федеральный слой экспортных ограничений, округлено"),
    lat: 56.9,
    lng: 61.0,
    severity: "serious",
    status: T("Gasoline exports are already restricted, aviation kerosene exports are banned until November 30, and a full diesel export ban was under discussion by July 2", "Экспорт бензина уже ограничен, экспорт авиакеросина запрещен до 30 ноября, а полный запрет экспорта дизеля к 2 июля находился в обсуждении"),
    fuel: T("Gasoline / aviation kerosene / diesel", "Бензин / авиакеросин / дизель"),
    lossWeight: 6,
    impactMode: "policy",
    impactMetric: "30 Nov",
    impactMetricLabel: T("jet fuel export ban", "запрет экспорта авиакеросина"),
    impactScope: T("Federal market-stabilization policy", "Федеральная политика стабилизации рынка"),
    impactCaveat: T("Policy signal of market stress, not a local station outage", "Политический сигнал стресса рынка, не локальный простой АЗС"),
    confidence: T("High for aviation kerosene ban, medium for diesel-ban discussion status", "Высокая по запрету авиакеросина, средняя по статусу обсуждения дизеля"),
    source: "governmentJetFuelBan",
    sourceUrl: "https://www.interfax.ru/business/1093002",
    observedAt: "2026-07-02",
    issueType: "regional_rationing",
  },
  {
    id: "russia-fuel-inflation-risk-cbr-july1",
    type: "region",
    title: T("Russia: fuel shock feeds inflation risk", "Россия: топливный шок усиливает инфляционный риск"),
    region: T("Russia nationwide", "Россия, общероссийский уровень"),
    place: T("Macro impact layer, rounded", "Макроэкономический слой, округлено"),
    lat: 60.2,
    lng: 90.0,
    severity: "watch",
    status: T("Bank of Russia noted that the fuel-market situation may have a longer inflation effect than in previous episodes, because gasoline and diesel affect consumer prices directly and through transport costs", "Банк России указал, что ситуация на топливном рынке может дольше влиять на инфляцию, так как бензин и дизель влияют на цены напрямую и через транспортные издержки"),
    fuel: T("Gasoline / diesel inflation channel", "Инфляционный канал бензина / дизеля"),
    lossWeight: 4,
    impactMode: "macro",
    impactMetric: "longer",
    impactMetricLabel: T("inflation pass-through", "перенос в инфляцию"),
    impactScope: T("National inflation and transport-cost channel", "Федеральная инфляция и транспортные издержки"),
    impactCaveat: T("Macro risk marker, not a physical outage", "Маркер макро-риска, не физический простой"),
    confidence: T("High: Bank of Russia summary and Interfax coverage", "Высокая: резюме Банка России и сообщение Интерфакса"),
    source: "centralBankInflation",
    sourceUrl: "https://www.interfax.ru/business/1099407",
    observedAt: "2026-07-01",
    issueType: "price_spike",
  },
  {
...
const regionStress = [
  ...
  { region: T("Krasnodar Krai", "Краснодарский край"), lat: 45.4, lng: 39.0, severity: "serious", score: 74, affectedStations: 180, note: T("Refinery disruption, Anapa queues and informal resale of queue spots point to regional stress.", "Повреждения НПЗ, очереди в Анапе и перепродажа мест в очередях указывают на региональный стресс.") },
  { region: T("Moscow / Moscow Oblast", "Москва / Московская область"), lat: 55.7, lng: 37.3, severity: "critical", score: 91, affectedStations: 260, note: T("Moscow refinery is unlikely to restart in 2026 and queues remain visible in the capital-region supply zone.", "Московский НПЗ вряд ли перезапустится в 2026 году, очереди остаются видимыми в столичном контуре снабжения.") },
  { region: T("Central Russia / Volga", "Центральная Россия / Поволжье"), lat: 54.7, lng: 48.2, severity: "serious", score: 78, affectedStations: 230, note: T("Multi-region shortage cluster plus refinery outages in Ryazan, Samara and Nizhny Novgorod areas.", "Межрегиональный кластер дефицита плюс простои НПЗ в районах Рязани, Самары и Нижнего Новгорода.") },
  ...
  { region: T("Moscow evening shortage", "Москва: вечерний дефицит"), lat: 55.8, lng: 37.6, severity: "critical", score: 90, affectedStations: 240, note: T("Reuters reported queues and private-station prices above 80 RUB/L, while the refinery outage now looks long-duration.", "Reuters сообщил об очередях и ценах у частных АЗС выше 80 руб/л, а простой НПЗ теперь выглядит долгосрочным.") },
  { region: T("Sevastopol price spike", "Севастополь: скачок цены"), lat: 44.6, lng: 33.5, severity: "critical", score: 98, affectedStations: 90, note: T("Rosstat reported Sevastopol gasoline prices up 30% in the June 23-29 week.", "Росстат сообщил рост цен на бензин в Севастополе на 30% за неделю 23-29 июня.") },
  { region: T("Nizhny Novgorod refinery belt", "Нижегородский контур НПЗ"), lat: 56.1, lng: 44.2, severity: "critical", score: 86, affectedStations: 130, note: T("Kstovo refinery reports on July 2 add primary-processing risk to the central supply belt.", "Сообщения по Кстово 2 июля добавляют риск первичной переработки в центральном контуре снабжения.") },
  ...
  { region: T("Nationwide shortage reports", "Общероссийские сообщения о дефиците"), lat: 58.5, lng: 76.0, severity: "critical", score: 84, affectedStations: 1450, note: T("July 2 research shifts the map from local incidents to systemic refinery, transport, import and retail stress.", "Ресерч на 2 июля смещает карту от локальных инцидентов к системному стрессу НПЗ, транспорта, импорта и розницы.") },
];
