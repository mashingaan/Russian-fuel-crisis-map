...
select
  ...
  58.5,
  76.0,
  'X video report: motorists complain about warning lights, detonation and power loss after the introduction of an older Euro-3 fuel standard at gas stations. Treat as a nationwide fuel-quality damage signal unless station-level locations are later verified.',
  'Fuel quality / Euro-3 vehicle damage reports',
